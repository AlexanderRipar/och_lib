...
namespace och
{
	...
	///*///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
	//
	//cstring_tokenizer::cstring_tokenizer(const char* text, const char* delimiters) : text{ text }, delimiters{ delimiters } {}
	//
	//bool cstring_tokenizer::is_delimiter(char c)
	//{
	//	for (int i = 0; delimiters[i]; ++i)
	//	{
	//		if (c == delimiters[i])
	...
	//}
	//
	//och::stringview cstring_tokenizer::operator()()
	//{
	//	while (is_delimiter(*text))
	//		++text;
	//
